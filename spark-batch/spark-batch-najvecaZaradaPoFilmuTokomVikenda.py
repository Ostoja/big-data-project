#prikazuje najvecu zaradu po filmu tokom vikenda
...
print df.groupBy("movie_id").agg(f.max("boxOffice").alias("maxBoxOffice")).orderBy("maxBoxOffice", ascending = False).show(50) 
